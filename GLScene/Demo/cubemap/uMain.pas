...
uses
  ...
  GLWin32Viewer, GLCrossPlatform, BaseClasses, GLScene, GLMaterial,
  GLCadencer, GLObjects, GLCoordinates, GLTexture, GLKeyboard, uDDStex;
...
begin
  ...
  with DDStex( matlib, 'cubemap', 'cubemap.dds' ).Material do begin
...
begin
  ...
  with mouse.CursorPos do begin
    dc_cam.TurnAngle := dc_cam.TurnAngle + (width div 2 - X) * 0.2;
    cam.PitchAngle := cam.PitchAngle + (height div 2 - Y) * 0.2;
  end;
