...
uses
  ...
  Dialogs, GLScene, GLObjects, GLCoordinates, GLWin32Viewer, VectorGeometry,
  VectorTypes, GLKeyboard, GLCrossPlatform, BaseClasses, GLCadencer,
  StdCtrls, ExtCtrls, Spline;
