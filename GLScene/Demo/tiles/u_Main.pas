...
uses
  ...
  GLCadencer, GLWin32Viewer, GLCrossPlatform, BaseClasses, GLScene, GLMaterial,
  GLObjects, GLCoordinates, GLMesh, AsyncTimer, GLKeyboard, GLFBORenderer,
  GLRenderContextInfo, VectorGeometry, GLGeomObjects,
...
begin
  ...
  // resize viewport
  if (clientWidth - 40) / (clientHeight - 40) > 2 then begin
