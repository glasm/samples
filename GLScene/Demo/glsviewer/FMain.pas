...
uses
  ...
  Dialogs, ActnList, Menus, ImgList, ToolWin, ComCtrls, ExtCtrls, ExtDlgs,

  GLScene, GLWin32Viewer, GLVectorFileObjects, GLObjects, VectorGeometry,
  GLTexture, OpenGL1x, GLContext, VectorLists, GLCadencer, GLKeyBoard,
  GLMaterial, GLCoordinates, GLCrossPlatform, BaseClasses,
  GLFileOBJ, GLFileLWO, GLFileQ3BSP, GLFileOCT, GLFileMS3D,
  GLFileNMF, GLFileMD3, GLFile3DS, GLFileMD2, GLFileSMD, GLFileTIN, GLColor,
  GLFilePLY, GLFileGTS, GLFileSTL, GLRenderContextInfo, GLState, OpenGLTokens;
...
uses  Registry, PersistentClasses, MeshUtils, GLMeshOptimizer;
